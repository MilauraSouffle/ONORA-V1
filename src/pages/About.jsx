        ...
        <div className="space-y-24">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <h2 className="text-3xl font-bold mb-4 text-gray-900">Notre histoire</h2>
          ...
          {/* --- Bloc 2: Approche IA --- */}
          <div className="text-center">
            <h2 className="text-3xl font-bold mb-4 text-gray-900">Une IA pragmatique et à votre service</h2>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white/5 p-8 rounded-2xl border border-white/10 text-center">
                ...
                <h3 className="text-2xl font-bold mb-2 text-gray-900">Human.</h3>
              ...
              <div className="bg-white/5 p-8 rounded-2xl border border-white/10 text-center">
                ...
                <h3 className="text-2xl font-bold mb-2 text-gray-900">Digital.</h3>
              ...
              <div className="bg-white/5 p-8 rounded-2xl border border-white/10 text-center">
                ...
                <h3 className="text-2xl font-bold mb-2 text-gray-900">Intelligent.</h3>
          ...
          {/* --- Bloc 3: Équipe --- */}
          <div className="text-center">
            <h2 className="text-3xl font-bold mb-4 text-gray-900">Une équipe d'experts passionnés</h2>
            <p className="text-lg text-gray-900/70 max-w-3xl mx-auto mb-12">
          ...
          <div className="bg-gradient-to-r from-[#FF7F50]/80 to-[#002C5F]/80 p-12 rounded-2xl text-center">
            <h2 className="text-3xl font-bold mb-4 text-gray-900">Prêt à passer au niveau supérieur ?</h2>
