...
// Page complète des cas d'usage - Contenu déplacé depuis NoPortfolio
...
export default function UseCases() {
  return (
    <>
      <Helmet>
        <title>Cas d'usage ONORA – Résultats concrets pour entrepreneurs</title>
        <meta
          name="description"
          content="Cas d'usage réels : commerce, bâtiment, restauration, immobilier. ONORA transforme les problèmes business en résultats mesurables grâce à l'IA et au no-code."
        />
        <meta
          name="keywords"
          content="cas d'usage, résultats, commerce, bâtiment, restauration, immobilier, IA, no-code, ONORA"
        />
        <meta property="og:title" content="Cas d'usage ONORA – Résultats concrets" />
        <meta
          property="og:description"
          content="Pas de portfolio. Des résultats mesurables pour entrepreneurs et commerçants."
        />
      </Helmet>
            ...
            {useCases.map((item, index) => (
              ...
              >
                ...
                <div className="flex items-center justify-between mb-6">
                  <span
                    className={`text-xs font-mono tracking-wider uppercase ${item.iconColor} bg-white/5 px-3 py-1 rounded-full border border-white/5`}
                  >
                    {item.vertical}
                  </span>
                  <div
                ...
                <div className="mt-auto space-y-6">
                  ...
                  <div className="flex gap-3 items-start opacity-70 group-hover:opacity-100 transition-opacity duration-300">
                    ...
                    <p className="text-sm text-gray-900 leading-snug">
                      <span className="block text-xs uppercase tracking-wider text-red-400/80 mb-1 font-semibold">
                        Problème
                      </span>
                      {item.problem}
                    </p>
                  ...
                  <div className="flex gap-3 items-start opacity-80 group-hover:opacity-100 transition-opacity duration-300">
                    ...
                    <p className="text-sm text-gray-900 leading-snug">
                      <span className="block text-xs uppercase tracking-wider text-cyan-400/80 mb-1 font-semibold">
                        Solution ONORA
                      </span>
                      {item.solution}
                    </p>
                  ...
                  <div className="relative bg-black/20 rounded-xl p-4 border border-white/5 group-hover:border-emerald-500/30 transition-colors duration-300">
                    <div className="flex gap-3 items-start">
                      ...
                      <div>
                        <span className="block text-xs uppercase tracking-wider text-emerald-400 mb-1 font-semibold">
                          Résultat
                        </span>
