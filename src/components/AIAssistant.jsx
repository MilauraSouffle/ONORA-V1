...
export default function AIAssistant({ isActive, onToggle }) {
  return (
    <>
      ...
      <button
        onClick={onToggle}
        className="flex items-center gap-2 px-3 py-1.5 md:px-4 md:py-2 rounded-lg border border-white/20 bg-white/5 hover:bg-white/10 transition-all duration-300 text-xs md:text-sm text-gray-300 hover:text-white cursor-pointer cursor-hover"
      >
